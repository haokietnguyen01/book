		...
		<header id="header">
			<div class="container-fluid">
				<div class="row">
					...
					<div class="col-md-2">
						<div class="main-logo">
							<a href="{{url('/home')}}"><img src="{{asset('frontend/images/main-logo.png')}}" alt="logo"></a>
						</div>
						...
						<nav id="navbar">
							<div class="main-menu stellarnav">
								<ul class="menu-list">
									...
									<li class="menu-item"><a href="{{url('/book/list')}}" class="nav-link btn btn-outline-dark rounded-pill m-0">Manage Book</a></li>
								</ul>
